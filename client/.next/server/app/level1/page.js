...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 78464)), "/home/gianfranco/Documents/GitHub/TheSandWalker/client/src/app/level1/page.jsx"],
    ...
    const pages = ["/home/gianfranco/Documents/GitHub/TheSandWalker/client/src/app/level1/page.jsx"];
    ...
    const originalPathname = "/level1/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 74051))
...
var cjs = __webpack_require__(87495);
// EXTERNAL MODULE: ../node_modules/@starknet-react/core/dist/index.js
var dist = __webpack_require__(21005);
// EXTERNAL MODULE: ../node_modules/react-toastify/dist/react-toastify.esm.mjs
var react_toastify_esm = __webpack_require__(93628);
// EXTERNAL MODULE: ../node_modules/react-toastify/dist/ReactToastify.css
var ReactToastify = __webpack_require__(83168);
// EXTERNAL MODULE: ../node_modules/react-modal/lib/index.js
var lib = __webpack_require__(72562);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);
// EXTERNAL MODULE: external "next/dist/compiled/react"
var react_ = __webpack_require__(18038);
;// CONCATENATED MODULE: ./src/app/utils.js
...
function OpenModal({ available , connect , connectors  }) {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx((lib_default()), {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    className: "relative rounded-lg shadow bg bg-zinc-800",
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "py-6 px-10 mx-20 my-10 text-center",
                            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                        "data-modal-hide": "popup-modal",
                                        type: "button",
                                        className: "text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-600 rounded-lg border border-gray-900 text-md font-medium px-5 py-2.5 shadow-md hover:text-white focus:z-10",
                                        ...
                                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                    children: isWalletAvailable("bravoos", available) ? "Connect to Bravoos" : "install Bravoos"
                                                })
                                            ]
                                        })
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                        ...
                                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                                    children: isWalletAvailable("argentX", available) ? "Connect to argentX" : "Install argentX"
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                    className: "pl-10"
                                                })
    ...
    else return /*#__PURE__*/ jsx_runtime_.jsx(Button, {
...
function Button({ key , text , onClick  }) {
    return /*#__PURE__*/ jsx_runtime_.jsx("button", {
        type: "button",
        className: "bg-white hover:bg-gray-200 text-gray-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-xs  px-3 py-2 text-center",
        onClick: onClick,
        children: "Connect Wallet"
    }, "{key}");
}
function ConnectWallet() {
    const { connect , connectors , disconnect , available , refresh  } = (0,dist.useConnectors)();
    const { account , address , status  } = (0,dist.useAccount)();
    (0,react_.useEffect)(()=>{
    ...
    if (status === "connected") {
        return /*#__PURE__*/ jsx_runtime_.jsx("button", {
            type: "button",
            className: "text-black bg-white hover:bg-gray-200 focus:ring-4  focus:outline-none focus:ring-emerald-900 shadow-lg shadow-gray-400/50 dark:shadow-lg dark:shadow-gray-800/80  font-medium rounded-lg text-sm text-center mt-2 p-2",
            onClick: ()=>{
                navigator.clipboard.writeText(address);
                react_toastify_esm/* toast.success */.Am.success("Address Copied", {
                    position: "top-right",
                    autoClose: 2000,
            ...
            children: address.substring(0, 4) + ".." + address.substring(address.length - 4, address.length)
        });
    } else return /*#__PURE__*/ jsx_runtime_.jsx(OpenModal, {
        available: available,
...
// EXTERNAL MODULE: ../node_modules/react-syntax-highlighter/dist/esm/styles/hljs/agate.js
var agate = __webpack_require__(1912);
// EXTERNAL MODULE: ../node_modules/starknet/dist/index.mjs + 1 modules
var starknet_dist = __webpack_require__(64406);
;// CONCATENATED MODULE: ./src/app/level1/page.jsx
...
function Level1Page() {
    const { contract  } = (0,dist.useContract)({
        address: CONTRACT_ADDRESS,
        abi: level1
    });
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: /*#__PURE__*/ jsx_runtime_.jsx(dist.StarknetConfig, {
            connectors: connectors,
            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "relative flex h-screen flex-col items-center gap-5 justify-center bg-level-one bg-cover",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {}),
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("ul", {
                        className: "rounded-3xl flex flex-col gap-5 mx-5",
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("li", {
                                className: "rounded-3xl border-white bg-[#333] p-3 text-center text-white shadow-md backdrop-blur-md lg:p-5 lg:text-lg",
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                        className: "text-3xl p-2 text-amber-100",
                                        children: "Lvl 1: The elder door "
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                        className: "text-xs p-5",
                                        children: "In this level you should be able to get the code to unlock the door and get out from the pyramid."
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("li", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(cjs/* default */.ZP, {
                                        language: "rust",
                                        className: " text-left text-xs",
                                        style: agate/* default */.Z,
                                        children: `#[starknet::contract]
    mod Level1Code {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/gianfranco/Documents/GitHub/TheSandWalker/client/src/app/level1/page.jsx`)
