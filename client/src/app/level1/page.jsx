...
export default function Level1Page() {
  return (
   <div>
    ...
    <div>
          <h1 className="text-center text-l color-black tracking-tight text-amber-100 [text-shadow:_1px_1px_1px_rgb(0_0_0_/_20%)] lg:text-4xl">LVL 1</h1>
          <p className="rounded-3xl text-center leading-6 text-amber-900 lg:text-sm">
        ...
        <ul className="rounded-3xl flex flex-col gap-5 mx-5">
            <li className="rounded-3xl border-white bg-white/30 p-3 text-center text-white shadow-md backdrop-blur-md lg:p-5 lg:text-lg">
              <p className="text-3xl p-2 text-amber-100">INTRODUCTION</p>
